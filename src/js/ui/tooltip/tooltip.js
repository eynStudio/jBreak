angular.module('jb.ui')
    .provider('$jbTip', function () {
        ...
        this.$get = function ($window, $rootScope, $compile, $q, $templateCache, $http, $animate, $sce, $$rAF, $timeout, $jbPosition) {//dimensions,
    ...
    .directive('jbTip', function ($window, $location, $sce, $jbTip, $$rAF) {
