angular.module('jb.ui')
    ...
    .provider('$jbDate', function () {
        ...
        this.$get = function ($window, $document, $rootScope, $sce, $jbDateFormatter, datepickerViews, $jbTip, $timeout) {
    ...
    .directive('jbDate', function ($window, $parse, $q, $jbDateFormatter, $jbDateParser, $jbDate) {
    ...
    .provider('datepickerViews', function () {
        ...
        this.$get = function ($jbDateFormatter, $jbDateParser, $sce) {
