angular.module('jb.ui')
    ...
    .provider('$jbTime', function () {
        ...
        this.$get = function ($window, $document, $rootScope, $sce, $jbDateFormatter, $jbTip, $timeout) {
    ...
    .directive('jbTime', function ($window, $parse, $q, $jbDateFormatter, $jbDateParser, $jbTime) {
